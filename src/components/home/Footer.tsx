        ...
        <div className={`grid grid-cols-1 md:grid-cols-4 gap-4 ${isRTL ? 'text-right' : 'text-left'}`}>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className={`flex ${isRTL ? 'flex-row-reverse space-x-reverse' : ''} space-x-3`}>
              <a href="https://facebook.com" className="text-gray-600 hover:text-teal-600 transition-colors">
                <Facebook size={18} />
              </a>
              <a href="https://twitter.com" className="text-gray-600 hover:text-teal-600 transition-colors">
                <Twitter size={18} />
              </a>
              <a href="https://instagram.com" className="text-gray-600 hover:text-teal-600 transition-colors">
                <Instagram size={18} />
              </a>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className={`text-sm text-gray-600 hover:text-teal-600 transition-colors ${isRTL ? 'font-arabic' : ''}`}>
